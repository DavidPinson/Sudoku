...
namespace Sudoku.DP
{
  public class ConstraintCellPos
  {
    ...
    public static readonly List<List<int>> Board = new()
    {
      ...
      new List<int>() { 27, 28, 29, 30, 31, 32, 34, 35, 6, 15, 24, 42, 51, 60, 69, 78, 43, 44, 52, 53 }, // 33
      new List<int>() { 27, 28, 29, 30, 31, 32, 33, 35, 7, 16, 25, 43, 52, 61, 70, 79, 42, 44, 51, 53 }, // 34
      new List<int>() { 27, 28, 29, 30, 31, 32, 33, 34, 8, 17, 26, 44, 53, 62, 71, 80, 42, 43, 51, 52 }, // 35
