  ...
  public class ConstraintCellPos
  {
    ...
    public static List<List<int>> Board = new List<List<int>>()
    {
      new List<int>(){1,2,3,4,5,6,7,8,9,18,27,36,45,54,63,72,10,11,19,20}, // 0
			...
			new List<int>(){45,46,48,49,50,51,52,53,2,11,20,29,37,56,65,74,27,28,36,37}, // 47
			new List<int>(){45,46,47,49,50,51,52,53,3,12,21,30,38,57,66,75,31,32,40,41}, // 48
			new List<int>(){45,46,47,48,50,51,52,53,4,13,22,31,39,58,67,76,30,32,39,41}, // 49
			new List<int>(){45,46,47,48,49,51,52,53,5,14,23,32,40,59,68,77,30,31,39,40}, // 50
			new List<int>(){45,46,47,48,49,50,52,53,6,15,24,33,41,60,69,78,34,35,43,44}, // 51
			new List<int>(){45,46,47,48,49,50,51,53,7,16,25,34,42,61,70,79,33,35,42,44}, // 52
			new List<int>(){45,46,47,48,49,50,51,52,8,17,26,35,43,62,71,80,33,34,42,43}, // 53
    ...
    public static List<int> AllPossibleValues = new List<int>(9) { 1, 2, 3, 4, 5, 6, 7, 8, 9 };

    public static List<List<int>> HiddenSingleHouse = new List<List<int>>()
    {
